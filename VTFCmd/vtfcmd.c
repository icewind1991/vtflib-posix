...
char *stristr(const char *string, const char *strSearch)
{
    ...
    while(1)
	{
		...
		if(!strncasecmp(ptr, strSearch, strlen(strSearch)))
		{
			return (char *)ptr;
		}
...
int main(int argc, char* argv[])
{
	...
	default:
		for(i = 1; i < argc; i++)
		{
			...
			else if(strcasecmp(argv[i], "-postfix") == 0)
			{
				if(i + 1 < argc)
				{
					lpPostfix = argv[++i];
			...
			else if(strcasecmp(argv[i], "-alphaformat") == 0)
			{
				if(i + 1 < argc)
				{
					ImageFormat = StringToImageFormat(argv[++i]);
			...
			else if(strcasecmp(argv[i], "-exportformat") == 0)
			{
				if(i + 1 < argc)
				{
			...
			else if(strcasecmp(argv[i], "-rmethod") == 0)
			{
				if(i + 1 < argc)
				{
			...
			else if(strcasecmp(argv[i], "-rfilter") == 0)
			{
				if(i + 1 < argc)
				{
			...
			else if(strcasecmp(argv[i], "-rsharpen") == 0)
			{
				if(i + 1 < argc)
				{
			...
			else if(strcasecmp(argv[i], "-rwidth") == 0)
			{
			...
			else if(strcasecmp(argv[i], "-rheight") == 0)
			{
				if(i + 1 < argc && sscanf(argv[++i], "%u", &uiTemp0) == 1)
				{
			...
			else if(strcasecmp(argv[i], "-rclampwidth") == 0)
			{
				if(i + 1 < argc && sscanf(argv[++i], "%u", &uiTemp0) == 1)
				{
			...
			else if(strcasecmp(argv[i], "-rclampheight") == 0)
			{
				if(i + 1 < argc && sscanf(argv[++i], "%u", &uiTemp0) == 1)
				{
			...
			else if(strcasecmp(argv[i], "-gamma") == 0)
			{
				CreateOptions.bGammaCorrection = vlTrue;
			}
			else if(strcasecmp(argv[i], "-gcorrection") == 0)
			{
			...
			else if(strcasecmp(argv[i], "-nomipmaps") == 0)
			{
				CreateOptions.bMipmaps = vlFalse;
			}
			else if(strcasecmp(argv[i], "-mfilter") == 0)
			{
				if(i + 1 < argc)
				{
					MipmapFilter = StringToMipmapFilter(argv[++i]);
			...
			else if(strcasecmp(argv[i], "-msharpen") == 0)
			{
				if(i + 1 < argc)
				{
					SharpenFilter = StringToSharpenFilter(argv[++i]);
			...
			else if(strcasecmp(argv[i], "-nkernel") == 0)
			{
				if(i + 1 < argc)
				{
			...
			else if(strcasecmp(argv[i], "-nheight") == 0)
			{
				if(i + 1 < argc)
				{
			...
			else if(strcasecmp(argv[i], "-nalpha") == 0)
			{
				if(i + 1 < argc)
				{
			...
			else if(strcasecmp(argv[i], "-nscale") == 0)
			{
				if(i + 1 < argc && sscanf(argv[++i], "%f", &sTemp) == 1)
				{
			...
			else if(strcasecmp(argv[i], "-nwrap") == 0)
			{
				CreateOptions.bNormalWrap = vlTrue;
			}
			else if(strcasecmp(argv[i], "-bumpscale") == 0)
			{
				if(i + 1 < argc && sscanf(argv[++i], "%f", &sTemp) == 1)
				{
			...
			else if(strcasecmp(argv[i], "-nothumbnail") == 0)
			{
				CreateOptions.bThumbnail = vlFalse;
			}
			else if(strcasecmp(argv[i], "-noreflectivity") == 0)
			{
				CreateOptions.bReflectivity = vlFalse;
			}
			else if(strcasecmp(argv[i], "-shader") == 0)
			{
				if(i + 1 < argc)
				{
					lpShader = argv[++i];
			...
			else if(strcasecmp(argv[i], "-param") == 0)
			{
				if(i + 2 < argc)
				{
			...
			else if(strcasecmp(argv[i], "-recurse") == 0)
			{
				bRecursive = vlTrue;
			}
			else if(strcasecmp(argv[i], "-silent") == 0)
			{
				bSilent = vlTrue;
			}
...
void ProcessFile(vlChar *lpInputFile)
{
	...
	if(lpTemp == 0 || strcasecmp(lpTemp, ".vtf") != 0)
	{
		// Load input file.
	...
	if(bRecursive)
	{
		...
		if(dir != NULL)
		{
			while (de = readdir(dir))
			{
				...
				{
					sprintf(lpPath, "%s\\%s", lpInputFolder, de->d_name);
